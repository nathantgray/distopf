...
loadshape_data = pd.read_csv(f"{CASES_DIR}/csv/prev_123/default_loadshape.csv", header=0)
...
model = LinDistModelQ(branch_data, bus_data, gen_data, cap_data, None, loadshape_data, pv_loadshape_data,  bat_data, der=True, battery=True)
